 ...
 *          by this object. A constructor that creates a MyInteger object for
 *          the specified int value. A getter method that returns the int value.
 *          The methods isEven(), isOdd(), and isPrime() that return true if the
 *          value in this object is even, odd, or prime, respectively. The
 ...
 *          odd, or prime, respectively. The methods equals(int) and
 *          equals(MyInteger) that return true if the value in this object is
 *          equal to the specified value. A static method parseInt(char[]) that
 *          converts an array of numeric characters to an int value. A static
